...
namespace KeepAPets.Infra.Repository
{
    public class CategoryRepository:ICategoryRepository
    {
        ...
        public int Create(Category Data)
        {
            ...
            var result = DBContext.Connection.ExecuteAsync("AddCategory", p, commandType: CommandType.StoredProcedure);
            return 1;
        ...
        public int Update(Category Data)
        {
            ...
            var result = DBContext.Connection.ExecuteAsync("EditCategory", p, commandType: CommandType.StoredProcedure);
            return 1;
        }
