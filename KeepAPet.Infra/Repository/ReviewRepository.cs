...
namespace KeepAPets.Infra.Repository
{
    public class ReviewRepository:IReviewRepository
    {
        ...
        public int Create(Review Data)
        {
            ...
            p.Add("@ReviewType", Data.ReviewType, dbType: DbType.String, direction: ParameterDirection.Input);

            var result = DBContext.Connection.ExecuteAsync("AddReview", p, commandType: CommandType.StoredProcedure);
            return 1;
        ...
        public int Update(Review Data)
        {
            ...
            var result = DBContext.Connection.ExecuteAsync("EditReview", p, commandType: CommandType.StoredProcedure);
            return 1;
        }
